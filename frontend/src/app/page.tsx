...
export default function DictationPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-clinical-bg text-clinical-text font-sans">
      ...
      <aside className={`bg-clinical-panel border-clinical-border flex flex-col justify-between shrink-0 transition-all duration-300 ${isMaximized ? 'w-0 opacity-0 overflow-hidden border-r-0 pointer-events-none' : 'w-14 xl:w-56 2xl:w-64 border-r'}`}>
        <div>
          <div className="h-12 xl:h-14 px-3 xl:px-5 border-b border-clinical-border flex items-center justify-center">
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-slate-950/20">
        {/* Top Navbar */}
        <header className="h-12 xl:h-14 2xl:h-16 border-b border-clinical-border flex items-center justify-between px-4 xl:px-6 2xl:px-8 bg-clinical-panel shrink-0">
          <div></div>
